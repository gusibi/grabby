...
// registerTwitterTools registers the intent-level X/Twitter tools. They run in
// the user's logged-in browser via the "intercept" primitive; see
// docs/browser-executor-plan.md §7.
